...
class Qwen3MoeAdapterConfig(Qwen3MoeConfig):
    

    model_type = "qwen3-moe-adapter"
    ...
    def __init__(
        ...
        deq_routing_adapter=False,
        deq_routing_adapter_args=None,
        adapter_type=None,
        adapter_args=None,
        **kwargs,
    ):
        ...
        if embedded_routing_adapter:
            raise NotImplementedError("embedded_routing_adapter is not implemented for qwen3_modification")
        self.deq_routing_adapter = deq_routing_adapter
        if deq_routing_adapter:
            self.deq_routing_adapter_args = deq_routing_adapter_args or {}
